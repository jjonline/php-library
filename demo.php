...
<title>php-library示例</title>
<meta name="Author" content="Jea杨(http://blog.jjonline.cn)">
<meta name="keywords" content="php-library,晶晶博客" />
<meta name="description" content="晶晶在线站长晶晶的博客提供并分享的PHP常用库：php-library" />
...
<?php
/**
 * php-library示例 本示例中许多代码并未简写 主要是为了便于阅读和理解
...
<header class="header container">
	<h1 class="php-library">php-library示例 <em>相关代码详见：<a href="https://github.com/jjonline/php-library" target=_blank>https://github.com/jjonline/php-library</a></em></h1>
   <h2 class="php-library-des">注：本代码示例需要PHP5.3.0及其以上的PHP环境；当前服务器PHP版本：<?php echo PHP_VERSION;?></h2>
</header>
<section class="container">
   <article class="list fileSystem">
      <h2>php-library文件结构</h2>
      <ul class="php-library-dir">
         <?php
            getDirInfo(__DIR__);
         ?>
      </ul>
