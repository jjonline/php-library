...
class Hashids {
	...
	/**
	 * 构造函数
	 * @param shring $salt 盐值 防止破解的
	 * @param int $min_hash_length 生成的字符串最小长度
	 * @param string $alphabet 字符表 指定用那些字符
	 */
	...
	/**
	 * 获得数字的唯一字符串
	 * @param mixed int or int Array
	 * @return string [if return=='' An error occurred]
	 */	
